  ...
  async onSubmit(): Promise<void> {
    ...
    Swal.fire({
      ...
      try {
        ...
        this.productService.updateProductBySeller(this.productId, val).subscribe({
          next: () => Swal.fire('Updated!', 'Product updated successfully', 'success').then(() => this.router.navigate(['/seller/products'])),
